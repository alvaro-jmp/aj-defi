      ...
      div({ id: 'div_cont_mini_login', class: 'w3-display-container', style: { 'margin-top': props._margin_top } }, [
        div({ id: 'div_login', class: 'w3-display-topmiddle w3-card w3-padding custom-card2 w3-margin-top' }, [
          form({ ref: c => this.form_mini_login = c, id: 'form_mini_login', noValidate: '' }, [
            ...
            // alert status login
            div({ id: 'div_alert_email', class: props.settings_status_login.class, style: { display: props.settings_status_login.show ? 'block' : 'none' } }, [
              span({
                onclick: () => this.disable_alert(props.settings_status_login),
                class: 'w3-button w3-large w3-display-topright'
              }, ['×']),
              div({ style: 'width:95%;' }, [
                h6({}, [props.settings_status_login.msg])
              ])
            ]),
            ...
            //submit
            this.login_selector(props.login_type)
          ])
        ])
      ])
    )
